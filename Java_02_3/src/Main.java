...
//      1-1. equals
        String s3 = "hi";
        String s4 = "hi";
        System.out.println(s3.equals(s4)); // 두 데이터 비교
...
//      1-4. substring
        System.out.println(s7.substring(0, 3)); // Bye 가 출력된다.
        System.out.println(s7.substring(0, s7.indexOf("!") + 1)); // Bye! 가 출력된다.
...
//      3. 자료형 - 배열
        ...
        myArray3[1] = " ";
        myArray3[2] = "World!";
        System.out.println(myArray3); // [Ljava.lang.String;@1b6d3586 이러한 문자열이 출력
